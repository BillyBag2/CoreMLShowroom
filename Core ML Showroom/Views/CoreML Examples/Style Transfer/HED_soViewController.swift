...
class HED_soViewController: ModelViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        guard let model = try? VNCoreMLModel(for: HED_so().model) else {return}
